...
@transaction_1 = create(credit_card_number: 1234123498765432, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_1.id, result: 0)
@transaction_2 = create(credit_card_number: 1234123498765432, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_1.id, result: 0)
@transaction_3 = create(credit_card_number: 1234123412341234, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_2.id, result: 0)
@transaction_4 = create(credit_card_number: 1234123412341234, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_2.id, result: 0)
@transaction_5 = create(credit_card_number: 9876987698769876, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_3.id, result: 1)
@transaction_6 = create(credit_card_number: 1234987612349876, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_4.id, result: 0)
@transaction_7 = create(credit_card_number: 1234987612349876, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_4.id, result: 1)
@transaction_8 = create(credit_card_number: 1234987612349876, credit_card_expiration_date: 01/01/2026, invoice_id: @invoice_4.id, result: 0)